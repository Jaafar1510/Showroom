  ...
  var eventDates = [
    ...
    new Date("Apr 5, 2024 05:30:00").getTime(),
    new Date("Apr 5, 2024 09:00:00").getTime(),
    new Date("Apr 6, 2024 05:30:00").getTime(),
    new Date("Apr 6, 2024 09:00:00").getTime(),
    new Date("Apr 7, 2024 08:00:00").getTime(),
