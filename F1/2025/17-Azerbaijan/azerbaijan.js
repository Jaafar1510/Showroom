  ...
  var eventDates = [
    ...
    new Date("Sep 13, 2024 12:30:00").getTime(),
    new Date("Sep 13, 2024 16:00:00").getTime(),
    new Date("Sep 14, 2024 11:30:00").getTime(),
    new Date("Sep 14, 2024 15:00:00").getTime(),
    new Date("Sep 15, 2024 14:00:00").getTime(),
