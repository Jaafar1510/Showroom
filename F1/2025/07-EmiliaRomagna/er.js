  ...
  var eventDates = [
    ...
    new Date("May 17, 2024 11:30:00").getTime(),
    new Date("May 17, 2024 15:00:00").getTime(),
    new Date("May 18, 2024 10:30:00").getTime(),
    new Date("May 18, 2024 14:00:00").getTime(),
    new Date("May 19, 2024 13:00:00").getTime(),
