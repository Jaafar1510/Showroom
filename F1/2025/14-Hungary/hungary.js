  ...
  var eventDates = [
    ...
    new Date("Jul 19, 2024 14:30:00").getTime(),
    new Date("Jul 19, 2024 18:00:00").getTime(),
    new Date("Jul 20, 2024 13:30:00").getTime(),
    new Date("Jul 20, 2024 17:00:00").getTime(),
    new Date("Jul 21, 2024 16:00:00").getTime(),
