  ...
  var eventDates = [
    ...
    new Date("Apr 19, 2024 03:30:00").getTime(),
    new Date("Apr 19, 2024 07:30:00").getTime(),
    new Date("Apr 20, 2024 03:00:00").getTime(),
    new Date("Apr 20, 2024 07:00:00").getTime(),
    new Date("Apr 21, 2024 07:00:00").getTime(),
