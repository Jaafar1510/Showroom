  ...
  var eventDates = [
    ...
    new Date("Jul 26, 2024 11:30:00").getTime(),
    new Date("Jul 26, 2024 15:00:00").getTime(),
    new Date("Jul 27, 2024 10:30:00").getTime(),
    new Date("Jul 27, 2024 14:00:00").getTime(),
    new Date("Jul 28, 2024 17:00:00").getTime(),
