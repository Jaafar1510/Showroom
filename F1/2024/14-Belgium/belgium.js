  ...
  var eventDates = [
    ...
    new Date("Jul 26, 2024 14:30:00").getTime(),
    new Date("Jul 26, 2024 18:00:00").getTime(),
    new Date("Jul 27, 2024 13:30:00").getTime(),
    new Date("Jul 27, 2024 17:00:00").getTime(),
    new Date("Jul 28, 2024 16:00:00").getTime(),
