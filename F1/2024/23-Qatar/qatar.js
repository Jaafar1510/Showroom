  ...
  var eventDates = [
    ...
    new Date("Nov 29, 2024 13:30:00").getTime(),
    new Date("Nov 29, 2024 17:30:00").getTime(),
    new Date("Nov 30, 2024 13:00:00").getTime(),
    new Date("Nov 30, 2024 17:00:00").getTime(),
    new Date("Dec 01, 2024 17:00:00").getTime(),
