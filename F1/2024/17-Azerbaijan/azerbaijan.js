  ...
  var eventDates = [
    ...
    new Date("Sep 13, 2024 09:30:00").getTime(),
    new Date("Sep 13, 2024 13:00:00").getTime(),
    new Date("Sep 14, 2024 08:30:00").getTime(),
    new Date("Sep 14, 2024 12:00:00").getTime(),
    new Date("Sep 15, 2024 11:00:00").getTime(),
