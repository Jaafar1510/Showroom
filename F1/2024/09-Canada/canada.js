  ...
  var eventDates = [
    ...
    new Date("Jun 7, 2024 17:30:00").getTime(),
    new Date("Jun 7, 2024 21:00:00").getTime(),
    new Date("Jun 8, 2024 16:30:00").getTime(),
    new Date("Jun 8, 2024 20:00:00").getTime(),
    new Date("Jun 9, 2024 18:00:00").getTime(),
