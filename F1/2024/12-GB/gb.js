  ...
  var eventDates = [
    ...
    new Date("Jul 5, 2024 14:30:00").getTime(),
    new Date("Jul 5, 2024 18:00:00").getTime(),
    new Date("Jul 6, 2024 13:30:00").getTime(),
    new Date("Jul 6, 2024 17:00:00").getTime(),
    new Date("Jul 7, 2024 17:00:00").getTime(),
