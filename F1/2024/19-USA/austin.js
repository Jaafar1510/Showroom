  ...
  var eventDates = [
    ...
    new Date("Oct 18, 2024 17:30:00").getTime(),
    new Date("Oct 18, 2024 21:30:00").getTime(),
    new Date("Oct 19, 2024 18:00:00").getTime(),
    new Date("Oct 19, 2024 22:00:00").getTime(),
    new Date("Oct 20, 2024 19:00:00").getTime(),
