  ...
  var eventDates = [
    ...
    new Date("Jul 19, 2024 11:30:00").getTime(),
    new Date("Jul 19, 2024 15:00:00").getTime(),
    new Date("Jul 20, 2024 10:30:00").getTime(),
    new Date("Jul 20, 2024 14:00:00").getTime(),
    new Date("Jul 21, 2024 13:00:00").getTime(),
