  ...
  var eventDates = [
    ...
    new Date("May 24, 2024 14:30:00").getTime(),
    new Date("May 24, 2024 18:00:00").getTime(),
    new Date("May 25, 2024 13:30:00").getTime(),
    new Date("May 25, 2024 17:00:00").getTime(),
    new Date("Apr 7, 2024 16:00:00").getTime(),
