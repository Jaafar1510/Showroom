  ...
  var eventDates = [
    ...
    new Date("May 24, 2024 11:30:00").getTime(),
    new Date("May 24, 2024 15:00:00").getTime(),
    new Date("May 25, 2024 10:30:00").getTime(),
    new Date("May 25, 2024 14:00:00").getTime(),
    new Date("May 26, 2024 13:00:00").getTime(),
