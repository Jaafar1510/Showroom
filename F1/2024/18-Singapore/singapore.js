  ...
  var eventDates = [
    ...
    new Date("Sep 20, 2024 09:30:00").getTime(),
    new Date("Sep 20, 2024 13:00:00").getTime(),
    new Date("Sep 21, 2024 09:30:00").getTime(),
    new Date("Sep 21, 2024 13:00:00").getTime(),
    new Date("Sep 22, 2024 12:00:00").getTime(),
